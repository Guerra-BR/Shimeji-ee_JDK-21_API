...
public class Script extends Variable {
    ...
    public Script(final String source, final boolean clearAtInitFrame) throws VariableException {
        ...
        try {
            ...
            throw new VariableException(VShimejiApplication.getInstance().getLanguageBundle().getString("ScriptCompilationErrorMessage") + ": " + this.source, e);
        }
    }
    ...
    public synchronized Object get(final VariableMap variables) throws VariableException {
        ...
        try {
            ...
            throw new VariableException(VShimejiApplication.getInstance().getLanguageBundle().getString("ScriptEvaluationErrorMessage") + ": " + source, e);
        }
