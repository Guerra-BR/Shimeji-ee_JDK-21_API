...
public class SettingsWindow extends JDialog {
    ...
    public boolean display() {
        ...
        Properties properties = VShimejiApplication.getInstance().getProperties();
        ...
        // localisation
        ResourceBundle language = VShimejiApplication.getInstance().getLanguageBundle();
    ...
    private void browseToUrl(String url) {
        try {
            ...
            if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                ...
                JOptionPane.showMessageDialog(this, VShimejiApplication.getInstance().getLanguageBundle().getString("FailedOpenWebBrowserErrorMessage") + " " + url, "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    {// GEN-HEADEREND:event_btnAddInteractiveWindowActionPerformed
        // add button
        String inputValue = JOptionPane.showInputDialog(rootPane, VShimejiApplication.getInstance().getLanguageBundle().getString("InteractiveWindowHintMessage"), VShimejiApplication.getInstance().getLanguageBundle().getString("AddInteractiveWindow"), JOptionPane.QUESTION_MESSAGE).trim();
