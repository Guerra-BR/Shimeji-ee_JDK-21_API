...
//     private Component lastFocused = null;
    ...
    public MenuScroller(JPopupMenu menu, int scrollCount, int interval,
        ...
        if (scrollCount <= 0 || interval <= 0) {
            throw new IllegalArgumentException(VShimejiApplication.getInstance().getLanguageBundle().getString("ScrollCountIntervalBelowZeroErrorMessage"));
        }
        if (topFixedCount < 0 || bottomFixedCount < 0) {
            throw new IllegalArgumentException(VShimejiApplication.getInstance().getLanguageBundle().getString("CountsCannotBeNegativeErrorMessage"));
        }
...
//         menu.removeMenuKeyListener(menuScrollerMenuKeyListener);
    ...
    public void setInterval(int interval) {
        if (interval <= 0) {
            throw new IllegalArgumentException(VShimejiApplication.getInstance().getLanguageBundle().getString("IntervalBelowZeroErrorMessage"));
        }
    ...
    public void setScrollCount(int scrollCount) {
        if (scrollCount <= 0) {
            throw new IllegalArgumentException(VShimejiApplication.getInstance().getLanguageBundle().getString("ScrollCountErrorMessage"));
        }
