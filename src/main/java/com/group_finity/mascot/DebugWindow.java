...
public class DebugWindow extends JFrame {
    ...
    public void setVisible(boolean b) {
        if (b) {
            lblBehaviour.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("Behaviour"));
            lblShimejiX.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("ShimejiX"));
            lblShimejiY.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("ShimejiY"));
            lblActiveIE.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("ActiveIE"));
            lblWindowX.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("WindowX"));
            lblWindowY.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("WindowY"));
            lblWindowWidth.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("WindowWidth"));
            lblWindowHeight.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("WindowHeight"));
            lblEnvironmentX.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("EnvironmentX"));
            lblEnvironmentY.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("EnvironmentY"));
            lblEnvironmentWidth.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("EnvironmentWidth"));
            lblEnvironmentHeight.setText(VShimejiApplication.getInstance().getLanguageBundle().getString("EnvironmentHeight"));
        }
        super.setVisible(b);
    }
