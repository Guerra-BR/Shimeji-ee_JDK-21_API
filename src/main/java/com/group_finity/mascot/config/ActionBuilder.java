        ...
        try {
            ...
            if (type.equals(schema.getString("Embedded"))) {
                try {
                    ...
                    throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedClassActionInitialiseErrorMessage") + "(" + this + ")", e);
                } catch (final IllegalAccessException e) {
                    throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("CannotAccessClassActionErrorMessage") + "(" + this + ")", e);
                } catch (final ClassNotFoundException e) {
                    throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("ClassNotFoundErrorMessage") + "(" + this + ")", e);
                } catch (NoSuchMethodException e) {
                    // TODO Get translations for the following error message
                    throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("ClassConstructorNotFoundErrorMessage") + "(" + this + ")", e);
                ...
                throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("UnknownActionTypeErrorMessage") + "(" + this + ")");
            }

        } catch (final AnimationInstantiationException e) {
            throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedCreateAnimationErrorMessage") + "(" + this + ")", e);
        } catch (final VariableException e) {
            throw new ActionInstantiationException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedParameterEvaluationErrorMessage") + "(" + this + ")", e);
        }
    }
