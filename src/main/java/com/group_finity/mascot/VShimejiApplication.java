...
public class VShimejiApplication {

    private static final Logger log = Logger.getLogger(VShimejiApplication.class.getName());
    ...
    private static VShimejiApplication instance = new VShimejiApplication();
    private Properties properties = new Properties();
    private ResourceBundle languageBundle;

    private JDialog form;

    public static VShimejiApplication getInstance() {
        return instance;
    }
    ...
    public static void main(final String[] args) {
        SpringApplication.run(VShimejiApplication.class, args);
        try {
            getInstance().run();
        } catch (OutOfMemoryError err) {
            log.log(Level.SEVERE, "Out of memory. There are probably too many "
     ...
     */
    public Mascot createMascot(String imageSet) {
    ...
    public ArrayList<String> getImageSets() {
        return imageSets;
    }
