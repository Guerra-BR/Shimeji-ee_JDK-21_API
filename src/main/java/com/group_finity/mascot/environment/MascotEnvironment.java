...
public class MascotEnvironment {
    ...
    public Area getWorkArea(Boolean ignoreSettings) {
        if (currentWorkArea != null) {
            if (ignoreSettings || Boolean.parseBoolean(VShimejiApplication.getInstance().getProperties().getProperty("Multiscreen", "true"))) {
    ...
    public Area getActiveIE() {
        ...
        if (currentWorkArea != null && !Boolean.parseBoolean(VShimejiApplication.getInstance().getProperties().getProperty("Multiscreen", "true")) && !currentWorkArea.toRectangle().intersects(activeIE.toRectangle())) {
            return new Area();
        }
