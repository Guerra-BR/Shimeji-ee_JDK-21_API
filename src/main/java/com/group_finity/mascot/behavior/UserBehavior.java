        ...
        try {
            ...
            if (!getAction().hasNext()) {
                try {
                    ...
                    throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedInitialiseFollowingBehaviourErrorMessage"), e);
                }
            }
        } catch (final VariableException e) {
            throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("VariableEvaluationErrorMessage"), e);
        }
        ...
        if (SwingUtilities.isLeftMouseButton(event)) {
                ...
                for (final Hotspot hotspot : mascot.getHotspots()) {
                    if (hotspot.contains(mascot, event.getPoint())) {
                        ...
                        try {
                            ...
                            throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedInitialiseFollowingBehaviourErrorMessage") + " " + hotspot.getBehaviour(), e);
                        }
                        break;
                    }
                }
            ...
            if (!handled && action != null && action instanceof ActionBase) {
                try {
                    ...
                    throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedDragActionInitialiseErrorMessage"), ex);
                }
            }
            ...
            if (!handled) {
                ...
                try {
                    ...
                    throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedDragActionInitialiseErrorMessage"), e);
                }
            }
        }
    }
        ...
        if (SwingUtilities.isLeftMouseButton(event)) {
            ...
            if (getMascot().isDragging()) {
                try {
                    ...
                    throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedDropActionInitialiseErrorMessage"), e);
                }
            }
        }
    }
    ...
    public synchronized void next() throws CantBeAliveException {
        try {
            ...
            if (hotspotState != HotspotState.ACTIVE) {
                if (getAction().hasNext()) {
                    ...
                    if (getMascot().getBounds().getX() + getMascot().getBounds().getWidth()
                        ...
                        if (Boolean.parseBoolean(VShimejiApplication.getInstance().getProperties().getProperty("Multiscreen", "true"))) {
                        ...
                        try {
                            ...
                            throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedFallingActionInitialiseErrorMessage"), e);
                        }
                    }
                } else {
                    ...
                    try {
                        ...
                        throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedInitialiseFollowingActionsErrorMessage"), e);
                    }
                }
            }
            ...
            try {
                ...
                throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("FailedFallingActionInitialiseErrorMessage"), ex);
            }
        } catch (final VariableException e) {
            throw new CantBeAliveException(VShimejiApplication.getInstance().getLanguageBundle().getString("VariableEvaluationErrorMessage"), e);
        }
